<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucChuDe.ascx.cs" Inherits="BookStore.CODE.QuanTriVien.SanPham.ucChuDe" %>

<div class="mt20">
    <div class="divflex">
    <div class="width60 scroll">
        <div class="HeaderText">DANH SÁCH NHÀ CHỦ ĐỀ</div>
        <asp:GridView CssClass="tbDanhMuc tableAdmin" ID="grChuDe" runat="server" AutoGenerateColumns="false">
            <Columns>
                <asp:BoundField ItemStyle-CssClass="TextCenter col10" HeaderText="Mã" DataField="ID" runat="server"/>
                <asp:BoundField ItemStyle-CssClass="col60" HeaderText="Tên" DataField="TenCD" runat="server" />
    ...
    <div class="width40">
        <div class="FormThemMoi ml20">
            ...
            <tr>
                <th colspan="2">
                    <asp:Label ID="lbThem" Text="THÊM MỚI CHỦ ĐỀ" runat="server" />
                </th>
            </tr>
            <tr>
                <td>Tên chủ đề</td>
                <td>
                    <asp:TextBox runat="server" ID="tbChuDe"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
